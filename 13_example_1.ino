...
#define _DUTY_MIN 720 // servo full clock-wise position (0 degree)
#define _DUTY_NEU 1900 // servo neutral position (90 degree)
...
// servo update interval (unit: msec)
...
void setup() {
  ...
  duty_change_per_interval = 
    (float)(_DUTY_NEU - _DUTY_MIN) * (_SERVO_SPEED / 90.0) * (INTERVAL / 1000.0);
 // duty_chage_per_inverval = 
